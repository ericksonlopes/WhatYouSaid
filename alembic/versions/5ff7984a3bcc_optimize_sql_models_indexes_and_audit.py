...
def upgrade() -> None:
    ...
    with op.batch_alter_table('content_sources', schema=None) as batch_op:
        ...
        batch_op.create_index(op.f('ix_content_sources_processing_status'), ['processing_status'], unique=False)
    ...
    with op.batch_alter_table('query_logs', schema=None) as batch_op:
        batch_op.create_index(op.f('ix_query_logs_created_at'), ['created_at'], unique=False)
        batch_op.create_index(op.f('ix_query_logs_subject_id'), ['subject_id'], unique=False)
