...
def test_enter_returns_weaviate_vector_store(monkeypatch):
    captured = {}
    ...
    ev = WeaviateVector(
        client=client_ctx, embedding_service=DummyEmbedding(), index_name='idx', text_key='text', use_multi_tenancy=False
    )
