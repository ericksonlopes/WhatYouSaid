...
class TestReRankService:
    ...
    def test_rerank_no_ranker(self):
        ...
        with patch("src.infrastructure.services.re_rank_service.Ranker", side_effect=Exception()):
            service = ReRankService()
    ...
    def test_rerank_empty_docs(self, monkeypatch):
        ...
        monkeypatch.setattr("src.infrastructure.services.re_rank_service.Ranker", MagicMock(return_value=mock_ranker))
        service = ReRankService()
