...
class TestKnowledgeSubjectService:
    ...
    def test_get_or_create_by_external_ref_new(self, service, mock_repo):
        mock_repo.get_by_external_ref.side_effect = [None, self.create_mock_model(external_ref="ext", name="Name")]
    ...
    def test_list_subjects(self, service, mock_repo):
        mock_repo.list.return_value = [self.create_mock_model(), self.create_mock_model()]
    ...
    def test_update_subject(self, service, mock_repo):
        ...
        mock_repo.update.assert_called_once_with(
            id=sid, name="Updated", description=None, external_ref=None
        )
