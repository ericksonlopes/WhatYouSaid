...
class TestModelLoaderService:
    ...
    def test_load_model_failure(self):
        with patch("src.infrastructure.services.model_loader_service.SentenceTransformer", side_effect=Exception("Load error")):
    ...
    def test_dimensions_property_failure(self):
        with patch("src.infrastructure.services.model_loader_service.SentenceTransformer") as mock_st:
            ...
            service = ModelLoaderService("test-model")
            with pytest.raises(RuntimeError, match="Failed to determine model embedding dimensions"):
